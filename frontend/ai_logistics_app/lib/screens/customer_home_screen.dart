...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final inProgressCount =
        _deliveries.where((d) => d['status'] == 'in_progress').length;
    ...
    return Scaffold(
            ...
            _isLoading
              ...
              child: const Column(
                children: [
                  ...
                  SizedBox(height: 4),
                  Text(
                    'Tap "New Delivery" to get started!',
                    style: TextStyle(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.local_shipping), label: 'My Deliveries'),
          BottomNavigationBarItem(
